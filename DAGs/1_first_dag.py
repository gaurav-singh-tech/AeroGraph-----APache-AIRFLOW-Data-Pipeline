...
def first_dag():#The dag decorator is used to define a DAG, and it takes the dag_id as an argument to uniquely identify the DAG
    ...
    @task.python
    def third_task():   
        print("This is the third task of the first DAG!, DAG Complete")
...
#Registering the DAG    
first_dag() #Finally, we call the function to create an instance of the DAG/to register the DAG with Airflow.
